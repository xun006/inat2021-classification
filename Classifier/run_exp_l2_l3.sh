...
# ============================================================
# Exp-L2L3:  LoRA + Sigmoid + L2 (Margin Ranking) + L3 (SupCon)
...
OUT="${PROJECT_ROOT}/Classifier/output/exp_l2_l3"
...
echo "Exp-L2L3 training complete. Exporting outputs..."
...
echo "Exp-L2L3 done. Results in ${OUT}"
